...
import { Charts } from 'components/items/elements/Charts';
    ...
    <main>
      ...
      <div className="flex items-center justify-center min-h-full px-0 py-12 sm:px-6 lg:px-8 relative">
        <div className="w-full space-y-8 flex flex-col items-center">
          ...
          <div className="flex mx-auto w-full h-[120px] bg-white rounded-none sm:rounded-3xl border border-lightGrey mt-10">
            <div className="w-1/3 min-w-[40px]  h-[120px] flex flex-col items-center justify-center">
            ...
            <div className="w-1/3 min-w-[40px] h-[120px] flex flex-col items-center justify-center border border-t-0 border-b-0 border-l-lightGrey border-r-lightGrey relative">
              <p className="text-heading-sm sm:text-heading-lg">0</p>
          ...
          <div className="mt-10 flex flex-col lg:flex-row justify-center items-center gap-6 w-full">
            <div className="xs:w-[500px]  w-full h-80 border border-lightGrey rounded-3xl p-4">
            ...
            <div className="xs:w-80 w-full h-80 rounded-3xl bg-primary flex flex-col justify-center items-center pb-8 pt-[72px] relative">
              <CircularProgressbar
                value={3}
                strokeWidth={8}
                styles={buildStyles({
